this.ckan.module('account-request-manage', function($, _) {
  return {
    options: {
    },
      ...
      $.ajax(
	{
          ...
          success:function(data, textStatus, jqXHR)
          {
            ...
            if (action=='approve'){
              $('.btn', row).closest('td').html('Approved. Notification has been sent to the user');
            } else {
              $('.btn', row).closest('td').html('Rejected. Notification has been sent to the user');
            }
          },
